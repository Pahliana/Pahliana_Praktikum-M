    ...
    <div class="col">
        ...
        if(isset($_POST["simpan_button"])){
            ...
            $bagian_id = $_POST["bagian_id"];
                ...
                $update_sql = "UPDATE karyawan SET 
                    nama='$nama',
        ...
        $find_sql= "SELECT * FROM karyawan WHERE nik=$nik";
        ...
        <div class="card px-3 py-3">
            <form action="" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" nik="nik" name="nik" 
                ...
                <div class="col mb-3 mt-3">
                    ...
                    <?php
                        ...
                        $result_bagian = mysqli_query($connection, $select_sql);
                        if (!$result_bagian) {
                            ?>
                                <div class="alert alert-danger" role="alert">
                                    <?php echo mysqli_error($connection) ?>
